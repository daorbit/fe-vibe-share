...
const ShareDrawer = ({
  ...
  const shareOptions = [
    { id: "copy", name: "Copy Link", icon: <Link2 className="w-6 h-6" />, bgColor: "bg-zinc-600" },
    { id: "whatsapp", name: "WhatsApp", icon: <WhatsAppIcon />, bgColor: "bg-[#25D366]" },
    { id: "twitter", name: "X", icon: <XIcon />, bgColor: "bg-black" },
    { id: "facebook", name: "Facebook", icon: <FacebookIcon />, bgColor: "bg-[#1877F2]" },
    { id: "email", name: "Email", icon: <Mail className="w-6 h-6" />, bgColor: "bg-zinc-500" },
    { id: "reddit", name: "Reddit", icon: <RedditIcon />, bgColor: "bg-[#FF4500]" },
    { id: "linkedin", name: "LinkedIn", icon: <LinkedInIcon />, bgColor: "bg-[#0A66C2]" },
    { id: "telegram", name: "Telegram", icon: <TelegramIcon />, bgColor: "bg-[#0088cc]" },
    { id: "messenger", name: "Messenger", icon: <MessengerIcon />, bgColor: "bg-[#0084FF]" },
    { id: "pinterest", name: "Pinterest", icon: <PinterestIcon />, bgColor: "bg-[#E60023]" },
  ];
        ...
        <div className="px-5 py-4 border-b border-white/10">
          <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
            {shareOptions.map((option) => (
              ...
              >
                <div className={`w-14 h-14 ${option.bgColor} rounded-full flex items-center justify-center text-white shadow-lg`}>
                  {option.icon}
                </div>
